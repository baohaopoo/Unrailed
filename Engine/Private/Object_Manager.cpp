...
CGameObject * CObject_Manager::Get_GameObject(_uint iLevelIndex, const _tchar * pLayerTag, const _tchar * pComponentTag, _uint iIndex)
{
	return nullptr;
}
...
HRESULT CObject_Manager::Delete_GameObject(_uint iLevelIndex, const _tchar * pLayerTag, CGameObject * _pObject)
{
	if (iLevelIndex >= m_iNumLevels || nullptr == _pObject)
		return E_FAIL;
...
HRESULT CObject_Manager::Save_Data(const TCHAR * _strFilePath, CGameObject* _pGameObject)
{
...
HRESULT CObject_Manager::Load_Data(const TCHAR* _strFilePath, _uint iLevelIndex, const _tchar* pLayerTag)
{
...
void CObject_Manager::Tick(_uint iNumLevel, _float fTimeDelta)
{
...
void CObject_Manager::LateTick(_uint iNumLevel, _float fTimeDelta)
{
	for (auto& Pair : m_pLayers[iNumLevel])
	{
		Pair.second->LateTick(fTimeDelta);
...
map<const _tchar*, class CLayer*>& CObject_Manager::Find_LevelLayers(_uint iLevelIndex)
{
...
CGameObject * CObject_Manager::Find_Object(_uint iLevelIndex, const _tchar * pLayerTag, const string & _strObjectName)
{
	if (iLevelIndex >= m_iNumLevels)
		return nullptr;
