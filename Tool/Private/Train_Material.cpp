...
{
	m_eType = (OBJECT_TYPE)(int)OBJECT_TYPE::OBJECT_TRAIN_MATERIAL;
}
...
HRESULT CTrain_Material::SetUp_Components(void* pArg)
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::SetUp_Components(Component_VIBuffer, LEVEL_STATIC, Prototype_Compo_VIB_Object, (CComponent**)&m_pVIBufferCom, TEXT("Train_Material.dat"))))
		return E_FAIL;
...
void CTrain_Material::Get_Damage(void)
{
	--m_iLife;
