...
{
	m_eType = (OBJECT_TYPE)(int)OBJECT_TYPE::OBJECT_TRAIN_WATER;
}
...
HRESULT CTrain_Water::SetUp_Components(void* pArg)
{
	/* For.Com_Transform */
	...
	if (FAILED(__super::SetUp_Components(Component_VIBuffer, LEVEL_STATIC, Prototype_Compo_VIB_Object, (CComponent**)&m_pVIBufferCom, TEXT("Train_Water.dat"))))
		return E_FAIL;
...
void CTrain_Water::Get_Damage(void)
{
	--m_iLife;
