...
{
	m_eType = (OBJECT_TYPE)(int)OBJECT_TYPE::OBJECT_TRAIN_HEAD;
}
...
HRESULT CTrain_Head::SetUp_Components(void* pArg)
{
	/* For.Com_Transform */
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::SetUp_Components(Component_VIBuffer, LEVEL_STATIC, Prototype_Compo_VIB_Object, (CComponent**)&m_pVIBufferCom, TEXT("Train_Head.dat"))))
		return E_FAIL;
...
void CTrain_Head::Get_Damage(void)
{
	--m_iLife;
