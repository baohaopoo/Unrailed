...
void ExitBtn::Tick(_float fTimeDelta)
{
	...
	m_isCol = CheckIntersect(pTargetTransform->Get_State(CTransform::STATE_POSITION), 1.f, m_pTransformCom->Get_State(CTransform::STATE_POSITION), 1.f); //타겟 center, 타겟 반지름값. );
