...
{
	m_eType = OBJECT_TYPE::OBJECT_GRASS;
}
...
HRESULT CGrass::SetUp_Components(void* pArg)
{
	...
	if (FAILED(__super::SetUp_Components(Component_VIBuffer, LEVEL_STATIC, Prototype_Compo_VIB_Object, (CComponent**)&m_pVIBufferCom, TEXT("Grass.dat"))))
		return E_FAIL;
	...
	/* For.Com_Texture */
	if (FAILED(__super::SetUp_Components(Component_Texture, LEVEL_STATIC, TEXT("Prototype_Component_Texture_MinHee"), (CComponent**)&m_pTextureCom, nullptr)))
		return E_FAIL;
